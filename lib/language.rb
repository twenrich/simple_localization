...
module ArkanisDevelopment #:nodoc
  module Localization #:nodoc
    module Helper
      ...
      ERROR_TITLE_SINGULAR = '#{h(localized_object_name)} konnte wegen einem Fehler nicht gespeichert werden.'
      ERROR_TITLE_PLURAL = '#{h(localized_object_name)} konnte wegen #{error_count} Fehlern nicht gespeichert werden.'
