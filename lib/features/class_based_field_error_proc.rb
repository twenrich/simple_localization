...
# field_error_proc just adds the class +invalid+ to the form field and doesn't
# create a new element. If the form field element already has a class attribute
# the invalid class will be appended to the class list.
# 
